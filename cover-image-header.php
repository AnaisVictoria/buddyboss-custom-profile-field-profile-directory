				...
				<div class="flex">
					...
					<div class="bb-user-content-wrap">
						...
						<h2 class="user-nicename">
							...
							// Fetch the Business Name from BuddyBoss Profile Fields
							$business_name = function_exists('xprofile_get_field_data') ? xprofile_get_field_data('Business Name', $user_id) : '';

							// Show Business Name if available, otherwise show Full Name
							echo !empty($business_name) ? esc_html($business_name) : bp_core_get_user_displayname($user_id);
							?>
						</h2>
							<?php
							if ( ! empty( $member_type ) ) {
